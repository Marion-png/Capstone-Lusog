{{--
    ...
    'dashboard' | 'students' | 'consent' | 'feeding' | 'deworming' | 'assessment'.
--}}
@php
...
<aside class="asb-sidebar">
    ...
    <nav class="asb-nav">
        ...
        <a href="{{ route('dashboard.class-adviser', ['tab' => 'form']) }}" class="asb-link {{ $active === 'form' ? 'active' : '' }}">
        ...
        <a href="{{ route('health-assessments.index') }}" class="asb-link {{ $active === 'assessment' ? 'active' : '' }}">
