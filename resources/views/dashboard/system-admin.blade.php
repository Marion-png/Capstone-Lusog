...
<aside class="sidebar">
    ...
    <nav class="nav">
        ...
        <a href="{{ route('dashboard.system-admin') }}" class="active">System Admin</a>
    </nav>
    <div class="user"><div class="avatar">{{ substr(auth()->user()->name ?? 'SA',0,2) }}</div><div style="font-size:.78rem">System Admin</div></div>
</aside>
<div class="main">
    <header class="top"><div style="font-size:.82rem;color:#6f8c7a">Dashboard > System Administrator</div><div class="chip">Platform Control Center</div></header>
    <div class="content">
        ...
        <section class="stats">
            <article class="card stat"><b>24</b><span>Active users</span></article>
            <article class="card stat"><b>4</b><span>Pending account approvals</span></article>
            <article class="card stat"><b>11</b><span>Low-stock predictive alerts</span></article>
            <article class="card stat"><b>99.9%</b><span>System uptime (30d)</span></article>
        </section>
        ...
        <section class="grid">
            <article class="card section">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>Maria C. Lopez</td><td>School Nurse</td><td><span class="tag ok">Active</span></td><td><button class="btn">Edit</button></td></tr>
                        <tr><td>John R. Reyes</td><td>Clinic Staff</td><td><span class="tag ok">Active</span></td><td><button class="btn">Edit</button></td></tr>
                        <tr><td>Ana D. Cruz</td><td>School Head</td><td><span class="tag warn">Review</span></td><td><button class="btn">Approve</button></td></tr>
                        <tr><td>Tech Support Bot</td><td>Service Account</td><td><span class="tag bad">Disabled</span></td><td><button class="btn">Enable</button></td></tr>
                    </tbody>
                </table>
            </article>

            <article class="card section">
                <h3>Predictive Restocking and Alerts</h3>
                <div class="row"><span>Forecast window</span><span>30 days</span></div>
                <div class="row"><span>Critical threshold</span><span>20% remaining</span></div>
                <div class="row"><span>Email notification</span><span><span class="tag ok">Enabled</span></span></div>
                <div class="row"><span>SMS escalation</span><span><span class="tag warn">Nurse only</span></span></div>
                <div class="row"><span>DepEd report schedule</span><span>Monthly 5th day</span></div>
                <div class="row"><span>Audit logging</span><span><span class="tag ok">Strict mode</span></span></div>
            </article>
        </section>
    </div>
</div>
